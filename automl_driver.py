...
workspace_name = "Alzheimers" # PLACEHOLDER
subscription_id = "f2dffe88-5a27-4d56-92a6-07f7ea641df3" # PLACEHOLDER
resource_group = "AI-102" # PLACEHOLDER
experiment_name = "Alzheimersdetection" # PLACEHOLDER
iteration = "41"  # PLACEHOLDER
run_id = "AutoML_656be6d9-dae7-427e-872c-0defc426a590_41"  # PLACEHOLDER
entry_point = "get_data.py" # PLACEHOLDER
automl_settings = {'enable_early_stopping':True,'enable_ensembling':True,'enable_stack_ensembling':True,'ensemble_iterations':15,'enable_onnx_compatible_models':False,'max_cores_per_iteration':-1,'send_telemetry':True,'blacklist_algos':['TensorFlowLinearClassifier','TensorFlowDNN'],'whitelist_models':None,'compute_target':'Alzheimers','enable_dnn':False,'enable_code_generation':True,'experiment_exit_score':None,'experiment_timeout_minutes':360,'featurization':'auto','hyperdrive_config':None,'grain_column_names':None,'is_timeseries':False,'iteration_timeout_minutes':360,'max_concurrent_iterations':1,'metric_operation':'maximize','model_explainability':True,'n_cross_validations':None,'name':'Alzheimersdetection','path':'./sample_projects/Alzheimersdetection','primary_metric':'AUC_weighted','region':'eastus','resource_group':'AI-102','subscription_id':'f2dffe88-5a27-4d56-92a6-07f7ea641df3','task_type':'classification','validation_size':None,'test_size':0.2,'vm_type':'STANDARD_DS3_V2','workspace_name':'Alzheimers','label_column_name':'Group','positive_label':None,'save_mlflow':True,'enable_batch_run':True,'dataset_id':'c3402258-842a-4062-93f7-a8cd59be2083'} # PLACEHOLDER
pipeline_spec = "{\"pipeline_id\":\"__AutoML_Ensemble__\",\"objects\":[{\"module\":\"azureml.train.automl.ensemble\",\"class_name\":\"Ensemble\",\"spec_class\":\"sklearn\",\"param_args\":[],\"param_kwargs\":{\"automl_settings\":\"{'task_type':'classification','primary_metric':'AUC_weighted','ensemble_iterations':15,'is_timeseries':False,'name':'Alzheimersdetection','compute_target':'Alzheimers','subscription_id':'f2dffe88-5a27-4d56-92a6-07f7ea641df3','region':'eastus','grain_column_names':None}\",\"ensemble_run_id\":\"AutoML_656be6d9-dae7-427e-872c-0defc426a590_41\",\"experiment_name\":\"Alzheimersdetection\",\"workspace_name\":\"Alzheimers\",\"subscription_id\":\"f2dffe88-5a27-4d56-92a6-07f7ea641df3\",\"resource_group_name\":\"AI-102\"}}]}" # PLACEHOLDER
pipeline_id = "__AutoML_Ensemble__" # PLACEHOLDER
dataprep_json = "{\"datasets\":0,\"training_data\":{\"datasetId\":\"c3402258-842a-4062-93f7-a8cd59be2083\"}}" # PLACEHOLDER
